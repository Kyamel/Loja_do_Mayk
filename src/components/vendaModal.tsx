  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex justify-end" onClick={onClose}>
      ...
      >
        ...
        {produto.Stock === 0 ? (
          <p className="light:text-txlight dark:text-txDark m-auto mx-auto">Nenhum item no carrinho.</p>
        ) : (
          <ul className="space-y-4 border-b border-gray-300 w-full h-[500px] mx-auto">
              ...
              <li key={produto.id} className="pb-2 flex flex-col items-center w-full  space-y-4 mx-auto">
                ...
                <p className='text-lg font-semibold mt-2 light:text-txlight dark:text-txDark bg-green-600 max-w-32 rounded-2xl px-2 mx-auto'>R$ {produto.price.toFixed(2)}</p>
              </li>
        ...
        <button onClick={onClose} className=" bg-red-500 hover:bg-red-800 text-lg font-semibold light:text-txlight dark:text-txDark shadow cursor-pointer transition-colors duration-200 h-10 m text-center px-4 rounded w-52 disabled:opacity-50 mt-3 mx-auto mb-[60px]" aria-label="Fechar" title="Fechar">
          Fechar
        </button>
